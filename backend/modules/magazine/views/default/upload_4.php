...
use backend\modules\magazine\assets\AppAsset;
...
/* @var $model backend\modules\magazine\models\Magazine */
        ...
        <div class='row'>
            ...
            <div class='col-sm-9'>
                ...
                <label class="control-label" for="image-name_file">
                    <?= ($model->image_id ? 'ไฟล์เดิม ' . Html::a($model->image_id, '#') : 'ไฟล์ใหม่') ?>
                </label>
                ...
                ])->label(false)->hint('เป็นไฟล์ PDF เท่านั้น');
                ?>
