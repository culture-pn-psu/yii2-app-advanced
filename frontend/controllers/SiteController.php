 ...
 *--------------------*/
    ...
    public function actionSplash(){
        Yii::$app->view->theme->pathMap = ['@app/views' => '@webroot/themes/screen'];
        Yii::$app->view->theme->baseUrl = '@web/themes/screen';
        $this->layout = Yii::$app->view->theme->pathMap['@app/views'].'/layouts/main';
        
        
        //$this->layout = 'splashSceen.php';        
        return $this->render('splashSceen');
    }
    
    public function actionKing(){
        Yii::$app->view->theme->pathMap = ['@app/views' => '@webroot/themes/blank'];
        Yii::$app->view->theme->baseUrl = '@web/themes/blank';
        $this->layout = Yii::$app->view->theme->pathMap['@app/views'].'/layouts/main';
        
        
        //$this->layout = 'splashSceen.php';        
        return $this->render('king');
    }
}
