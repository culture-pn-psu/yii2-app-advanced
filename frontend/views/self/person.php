                ...
                <div role="tabpanel">
                    <ul class="nav main-tab nav-justified" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#tab1" role="tab" data-toggle="tab" aria-controls="tab1" aria-expanded="false">ทั้งหมด</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#tab2" role="tab" data-toggle="tab" aria-controls="tab2" aria-expanded="false">ผู้บริหาร</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#tab3" role="tab" data-toggle="tab" aria-controls="tab3" aria-expanded="false">ฝ่ายสนับสนุนบริหาร</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#tab4" role="tab" data-toggle="tab" aria-controls="tab4" aria-expanded="true">ฝ่ายวิจัย พัฒนาและส่งเสริมวัฒนธรรม</a>
                        </li>
                    </ul>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab2" aria-labelledby="tab2">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            echo Html::tag('h3', 'ผู้อำนวยการ',['class'=>'column-title']);
                                            $data = $position->getTreePerson(8);
                                        ...
                                        <div class="col-sm-12">
                                            <?php
                                            echo Html::tag('h3', 'รองผู้อำนวยการฝ่ายวางแผนและพัฒนาระบบบริหาร',['class'=>'column-title']);
                                            $data = $position->getTreePerson(9);
                                            echo $data['start'] . $data['end'];
                                             echo '<div class="clear"></div><br />';
                                            ?>
                                        </div>
                                        <div class="col-sm-12">
                                            <?php
                                            echo Html::tag('h3', 'รองผู้อำนวยการฝ่ายวิจัย พัฒนา และส่งเสริมวัฒนธรรม',['class'=>'column-title']);
                                            $data = $position->getTreePerson(10);
                                            echo $data['start'] . $data['end'];
                                             echo '<div class="clear"></div><br />';
                                            ?>
                                        </div>
