...
<div role="tabpanel">
    <ul class="nav main-tab nav-justified" role="tablist">
        <li role="presentation" class="active">
            <a href="#tab2555" role="tab" data-toggle="tab" aria-controls="tab2555" aria-expanded="false">2555-2559</a>
        </li>
        <li role="presentation" class="">
            <a href="#tab2551" role="tab" data-toggle="tab" aria-controls="tab2551" aria-expanded="false">2551-2554</a>
        </li>
    </ul>

    <div id="tab-content" class="tab-content">
        <div role="tabpanel" class="tab-pane fade active in" id="tab2555" aria-labelledby="tab2555">
            <?= $this->render('_strategic55-59') ?>
        </div>
        <div role="tabpanel" class="tab-pane fade" id="tab2551" aria-labelledby="tab2551">
            <?= $this->render('_strategic51-54') ?>
        </div>
    </div>
</div>
