...
//                    ],
                ...
                echo Nav::widget([
                    'items' => $nav->menu(2),
                    'options' => ['class' => 'nav navbar-nav', 'data-toggle' => 'collapse-nav','data-target'=>'#more-menu-2','data-width-offset'=>'.navbar-header, #more-menu-2'], // set this to nav-tab to get tab-styled navigation
                ]);
                ?>

                <div id="more-menu-2" class="pull-right dropdown">
                    <a href="#" class="dropdown-toggle btn navbar-btn btn-link" data-toggle="dropdown"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span>
                    </a>
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="icon-bar"></span>
